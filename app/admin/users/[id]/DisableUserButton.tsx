  ...
  if (disabled) {
    return (
      <button
        ...
        disabled={pending}
        className="inline-flex items-center gap-2 rounded-md bg-emerald-500/10 px-3 py-2 text-xs font-semibold text-emerald-700 ring-1 ring-emerald-500/30 transition hover:bg-emerald-500/20 disabled:opacity-50"
      >
  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-2 rounded-md bg-rose-500/10 px-3 py-2 text-xs font-semibold text-rose-700 ring-1 ring-rose-500/30 transition hover:bg-rose-500/20 disabled:opacity-40 disabled:cursor-not-allowed"
      >
      ...
      {open && (
        ...
        >
          ...
          <div
            ...
            className="relative w-full max-w-lg rounded-2xl border border-rose-500/30 bg-admin-card p-6 shadow-2xl"
          >
            <button
              type="button"
              onClick={() => !pending && setOpen(false)}
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0">
                <h3 className="text-lg font-bold text-zinc-900">Hesabı blokla</h3>
            ...
            <label className="mt-5 block text-sm">
              <span className="text-zinc-700">Bloklama səbəbi (ixtiyari)</span>
              <textarea
                value={reason}
