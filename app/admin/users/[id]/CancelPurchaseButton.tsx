  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-md bg-rose-500/10 px-2.5 py-1 text-[11px] font-semibold text-rose-700 ring-1 ring-rose-500/30 transition hover:bg-rose-500/20"
      >
        <X className="h-3 w-3" />
        Ləğv et
      </button>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1 text-sm text-zinc-600">
                  <span className="text-zinc-800">{title}</span> sifarişi ləğv ediləcək.
