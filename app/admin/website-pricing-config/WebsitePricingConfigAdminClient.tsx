...
export default function WebsitePricingConfigAdminClient() {
  ...
  return (
    <div className="space-y-6">
      <section className="rounded-2xl border border-admin-line bg-admin-card p-6">
        <h2 className="text-base font-bold text-zinc-900">Baza qiymət aralıqları</h2>
        <p className="mt-1 text-xs text-zinc-500">
          Hər sayt növü üçün minimum və maksimum baza qiyməti (AZN). AI yalnız
          bu aralıqdan dəyər qaytara bilər.
        </p>

        <div className="mt-5 overflow-hidden rounded-lg border border-admin-line">
                  ...
                  <tr key={t.key}>
                    ...
                    <td className="px-2 py-2">
                      <input
                        ...
                        className="w-full rounded border border-admin-line bg-admin-card px-2 py-1.5 text-sm text-zinc-900 outline-none focus:border-violet-500"
                      />
                    </td>
                    <td className="px-2 py-2">
                      <input
      ...
      <section className="rounded-2xl border border-admin-line bg-admin-card p-6">
        <h2 className="text-base font-bold text-zinc-900">AI parametrləri</h2>
        <p className="mt-1 text-xs text-zinc-500">
