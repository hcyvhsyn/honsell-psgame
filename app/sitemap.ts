...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticEntries: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/ea-play`, lastModified: now, changeFrequency: "weekly", priority: 0.7 },
    { url: `${SITE_URL}/hediyye-kartlari`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
    { url: `${SITE_URL}/hediyye-kartlari/honsell`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
