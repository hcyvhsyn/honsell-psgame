        ...
        <Container style={container}>
          ...
          <Section style={hero}>
            <Heading style={heading}>
              E-poçtu təsdiq et, <span style={accentPurple}>{userName}</span>.
            </Heading>
            <Text style={lede}>
              Hesabını yaratmağı tamamlamaq üçün aşağıdakı kodu daxil et.
              Kodun müddəti {expiresInMinutes} dəqiqəyə bitir.
            </Text>
          </Section>
          ...
          <Section style={footer}>
            <Text style={footerText}>
              Bu sorğunu sən etməmisənsə bu emailə əhəmiyyət vermə —
